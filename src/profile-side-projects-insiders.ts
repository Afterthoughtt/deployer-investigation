...
if (networkMap.insiders?.coinspot_insider) {
  ...
  if (cs.connected_susye_deployer) KNOWN[cs.connected_susye_deployer] = "SUSYE Deployer";
}
if (networkMap.insiders?.blofin_insider) {
  ...
  if (bl.blofin_passthrough) KNOWN[bl.blofin_passthrough] = "BloFin Passthrough";
}
